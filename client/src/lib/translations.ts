    ...
    intro: {
      ...
      expertise: {
        ...
        restructuring: {
          ...
          description: 'Implémentation de réorganisations (opérations de fusions&acquisitions, PSE, PDV, RCC)'
        },
        collective: {
  ...
  hero: {
    ...
    intro: {
      ...
      expertise: {
        ...
        restructuring: {
          title: 'Restructuring',
          description: 'Implementation of reorganizations (mergers & acquisitions, PSE, PDV, RCC)'
        },
        collective: {
