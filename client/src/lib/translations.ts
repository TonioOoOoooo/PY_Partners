export const translations = {
  fr: {
    ...
    intro: {
      ...
      description: 'Fondé par Sérafine Poyer et Virgile Puyau, PY Partners est un cabinet d\'avocats de droit social dédié à l\'accompagnement stratégique des Dirigeants et des Entreprises.',
      ...
      expertise: {
        ...
        strategic: {
          ...
          description: 'Accompagnement des Directions des Ressources Humaines'
        },
        restructuring: {
        ...
        litigation: {
          ...
          description: 'Gestion des litiges individuels et collectifs'
        },
        compliance: {
    ...
    about: {
      ...
      virgile: {
        ...
        bio: 'Depuis près de vingt ans, Virgile Puyau accompagne les entreprises françaises et internationales sur l\'ensemble des aspects liés aux relations individuelles et collectives de travail. Il est régulièrement distingué par des classements juridiques de renom, tels que The Legal 500, Best Lawyers et Décideurs.',
        education: 'Formation',
        contact: 'Contact'
      }
    },
    expertises: {
      ...
      areas: {
        ...
        litigation: {
          title: 'CONTENTIEUX SOCIAL',
          description: 'Représentation des dirigeants et employeurs dans le cadre des litiges individuels et collectifs devant les juridictions prud\'homales, civiles et administratives.'
        },
        security: {
    ...
    press: {
      title: 'Distinctions',
      description: 'Notre cabinet et nos associés sont régulièrement reconnus par les classements professionnels et nos clients.',
      testimonials: {
        first: {
          quote: '« Je travaille très régulièrement avec Virgile Puyau et son équipe. Il sait être particulièrement réactif et attentif aux problèmes que je rencontre en proposant systématiquement des solutions non seulement innovantes mais aussi et surtout particulièrement adaptées à mes besoins. »',
          source: 'Legal 500 – 2025'
        },
        second: {
          quote: '« L\'équipe dirigée par Virgile Puyau se distingue par son approche moderne et pragmatique du sujet. Leur travail de grande qualité prend en compte les besoins opérationnels et les contraintes de leurs clients. »',
    ...
    contact: {
      ...
      description: 'Pour toute demande, n\'hésitez pas à nous contacter en remplissant le formulaire ci-dessous ou en utilisant nos coordonnées directes.',
      form: {
        name: 'Nom',
        email: 'Email',
        phone: 'Téléphone',
      ...
      info: {
        ...
        address: {
          label: 'Adresse',
          value: '13 Rue Royale, 75008 PARIS'
        },
        email: {
          label: 'Email',
          value: 'contact@py-partners.com'
        },
        direct: {
          label: 'Contact direct',
          serafine: 'Sérafine Poyer: + 33 (0) 6 64 12 55 58',
          virgile: 'Virgile Puyau: + 33 (0) 6 03 93 33 67'
        }
      }
    },
    footer: {
  ...
  en: {
    ...
    intro: {
      ...
      expertise: {
        ...
        strategic: {
          ...
          description: 'Support for Human Resources Departments'
        },
        restructuring: {
          title: 'Restructuring',
        ...
        litigation: {
          ...
          description: 'Management of individual and collective disputes'
        },
        compliance: {
    ...
    about: {
      ...
      virgile: {
        name: 'Virgile Puyau',
        role: 'Founding Partner',
        bio: 'For nearly twenty years, Virgile Puyau has been supporting French and international companies on all aspects related to individual and collective labor relations. He is regularly distinguished by renowned legal rankings, such as The Legal 500, Best Lawyers and Décideurs.',
        education: 'Education',
        contact: 'Contact'
      }
    },
    expertises: {
      ...
      areas: {
        ...
        litigation: {
          title: 'SOCIAL LITIGATION',
          description: 'Representation of executives and employers in individual and collective disputes before labor, civil and administrative courts.'
        },
        security: {
    ...
    press: {
      title: 'Distinctions',
      description: 'Our firm and our partners are regularly recognized by professional rankings and our clients.',
      testimonials: {
        first: {
          quote: '"I work very regularly with Virgile Puyau and his team. He knows how to be particularly responsive and attentive to the problems I encounter by systematically offering solutions that are not only innovative but also and above all particularly adapted to my needs."',
          source: 'Legal 500 – 2025'
        },
        second: {
          quote: '"The team led by Virgile Puyau stands out for its modern and pragmatic approach to the subject. Their high-quality work takes into account the operational needs and constraints of their clients."',
          source: 'Legal 500 – 2024'
        }
      },
      recognition: 'Recognized in The Best Lawyers in France™ 2025 for work in Labor and Employment Law'
    ...
    contact: {
      title: 'Contact us',
      description: 'For any request, do not hesitate to contact us by filling out the form below or by using our direct contact details.',
      form: {
        name: 'Name',
        email: 'Email',
        phone: 'Phone',
