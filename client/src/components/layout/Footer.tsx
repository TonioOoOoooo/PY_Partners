      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="flex space-x-5">
              <a href="https://fr.linkedin.com/company/py-partners" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors duration-200" aria-label="LinkedIn PY Partners">
        ...
        <div className="mt-14 pt-8 border-t border-gray-800 text-center text-gray-500 text-xs">
          ...
          <div className="mt-2 text-gray-300 text-sm">
            Site développé par <a href="https://tomorrow-solutions.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-white font-semibold">AI Tomorrow Solutions</a>
          </div>
        </div>
      </div>
    </footer>
