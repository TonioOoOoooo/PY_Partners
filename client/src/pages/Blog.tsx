...
const Blog: React.FC = () => {
  ...
  const title = language === 'fr' ? 'Blog - PY Partners' : 'Blog - PY Partners';
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="alternate" hrefLang="fr" href="https://py-partners.com/fr/blog" />
        <link rel="alternate" hrefLang="en" href="https://py-partners.com/en/blog" />
        <link rel="canonical" href={`https://py-partners.com/${language === 'fr' ? 'fr' : 'en'}/blog`} />
      </Helmet>
